var a="cocoen",r=`${a}-component`;var u=(n,e)=>{let t;return(...o)=>{let i;return t&&clearTimeout(t),t=setTimeout(()=>{i=n(...o)},e),i}};var s=(n,e)=>{let t=0;n instanceof MouseEvent?t=n.clientX:n instanceof TouchEvent&&(t=n.touches[0].clientX);let o=e?.getBoundingClientRect().left||0;return t-o};var h=({dragElementWidth:n,hostElementWidth:e,x:t})=>{let o=t;t<0?o=n:t>=e&&(o=e-n);let i=o+n/2;return i/=e,i*100};var d=n=>Number.parseInt(window.getComputedStyle(n).width,10);var m=n=>`${n}%`;var p=`
  :host {

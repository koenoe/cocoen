var s="cocoen",r=`${s}-component`;var a=o=>Number.parseInt(window.getComputedStyle(o).width,10);var u=({dragElementWidth:o,hostElementWidth:e,x:t})=>{let n=t;t<0?n=o:t>=e&&(n=e-o);let i=n+o/2;return i/=e,i*100};var d=(o,e)=>{let t=0;o instanceof MouseEvent?t=o.clientX:o instanceof TouchEvent&&(t=o.touches[0].clientX);let n=e?.getBoundingClientRect().left||0;return t-n};var h=(o,e)=>{let t;return(...n)=>{let i;return t&&clearTimeout(t),t=setTimeout(()=>{i=o(...n)},e),i}};var m=o=>`${o}%`;var p=`
  :host {

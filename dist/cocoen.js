var Cocoen=(()=>{var c=Object.defineProperty;var u=(n,e)=>{for(var t in e)c(n,t,{get:e[t],enumerable:!0})};var p={};u(p,{create:()=>i,parse:()=>s});var l=(n,e)=>{let t;return(...o)=>{let d;return t&&clearTimeout(t),t=setTimeout(()=>{d=n(...o)},e),d}};var a="cocoen",r=`${a}-component`;var m=`
  #container {

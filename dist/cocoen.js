var Cocoen=(()=>{var c=Object.defineProperty;var u=(n,e)=>{for(var t in e)c(n,t,{get:e[t],enumerable:!0})};var p={};u(p,{create:()=>i,parse:()=>d});var a="cocoen",r=`${a}-component`;var h=(n,e)=>{let t;return(...o)=>{let l;return t&&clearTimeout(t),t=setTimeout(()=>{l=n(...o)},e),l}};var m=`
  #container {

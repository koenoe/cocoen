var Cocoen=(()=>{var g=Object.defineProperty;var v=(o,e)=>{for(var t in e)g(o,t,{get:e[t],enumerable:!0})};var f={};v(f,{create:()=>s,parse:()=>p});var a="cocoen",i=`${a}-component`;var d=o=>Number.parseInt(window.getComputedStyle(o).width,10);var u=({dragElementWidth:o,hostElementWidth:e,x:t})=>{let n=t;t<0?n=o:t>=e&&(n=e-o);let r=n+o/2;return r/=e,r*100};var l=(o,e)=>{let t=0;o instanceof MouseEvent?t=o.clientX:o instanceof TouchEvent&&(t=o.touches[0].clientX);let n=e?.getBoundingClientRect().left||0;return t-n};var h=(o,e)=>{let t;return(...n)=>{let r;return t&&clearTimeout(t),t=setTimeout(()=>{r=o(...n)},e),r}};var m=o=>`${o}%`;var E=`
  :host {

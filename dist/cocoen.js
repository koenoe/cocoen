var Cocoen=(()=>{var c=Object.defineProperty;var u=(n,e)=>{for(var t in e)c(n,t,{get:e[t],enumerable:!0})};var p={};u(p,{create:()=>r,parse:()=>h});var d=(n,e)=>{let t;return(...o)=>{let s;return t&&clearTimeout(t),t=setTimeout(()=>{s=n(...o)},e),s}};var a="cocoen",i=`${a}-component`;var m=`
  #container {
